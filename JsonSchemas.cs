    ...
    {
        {
            ...
            new List<(string name, string type, object defaultValue)>
            {
                ...
                ("headSprite", "String", "noSprite"),
                ("bodySprite", "String", "noSprite"),
                ("handSprite", "String", "noSprite"),
                ("shieldSprite", "String", "noSprite"),
                ("backSprite", "String", "noSprite"),
